...
htmlhelp_basename = 'PharosControllerdoc'
...
latex_documents = [
    (master_doc, 'PharosController.tex', 'Pharos Controller Documentation',
...
man_pages = [
    (master_doc, 'pharoscontroller', 'Pharos Controller Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'PharosController', 'Pharos Controller Documentation',
     author, 'PharosController', 'One line description of project.',
     'Miscellaneous'),
]
