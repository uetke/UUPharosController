...
class Measurement(QObject):
    ...
    def __init__(self, measure):
        ...
        self.scan_data = [] # List with the data generated by scans
        self.wait_for_line = False  # To configure whether the scan waits to read a certain amount of points
    ...
    def continuous_scans_waiting(self):
        """ Does continuous scans but waits until the line is complete to read from the DAQ and store the results."""
    ...
    def setup_continuous_scans(self, monitor=None):
        ...
        monitor['line_points'] = num_points
    ...
    def read_scans(self, points=0, timeout=0):
        """ Reads the data from the DAQ. It has 3 modes of operation:
            ...
            - points=0: splits the points and the buffer, i.e. this is ideal when acquiring more than 1 channel, since points and buffer have different meanings for NI.
