...
class Measurement(object):
    ...
    def setup_continuous_scans(self, monitor=None):
        ...
        num_points = (monitor['laser']['params']['stop_wavelength'] - monitor['laser']['params']['start_wavelength'])/ monitor['laser']['params']['interval_trigger']
        ...
        for d in self.daqs:
            ...
            if len(daq['monitor']) > 0:
                ...
                if 'start_source' in self.monitor['daq']:
                    if monitor['daq']['start_source'] is not None:
